...
PLATFORM_SUPPORTED_DOMAINS: dict[str, frozenset[str]] = {
    IBKR_PLATFORM: frozenset({US_EQUITY_DOMAIN, HK_EQUITY_DOMAIN, COMBOS_DOMAIN}),
}
...
PLATFORM_CAPABILITY_MATRIX = PlatformCapabilityMatrix(
    ...
    supported_inputs=frozenset(
        {"market_history", "benchmark_history", "feature_snapshot", "derived_indicators",
         "portfolio_snapshot", "russell_snapshot", "current_holdings", "market_data"}
    ),
