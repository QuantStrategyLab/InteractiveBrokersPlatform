...
IBKR_FEATURE_SNAPSHOT_PATH=gs://qsl-runtime-logs-shared/strategy-artifacts/us_equity/russell_top50_leader_rotation_aggressive_staging/russell_top50_leader_rotation_aggressive_feature_snapshot_latest.csv
IBKR_FEATURE_SNAPSHOT_MANIFEST_PATH=gs://qsl-runtime-logs-shared/strategy-artifacts/us_equity/russell_top50_leader_rotation_aggressive_staging/russell_top50_leader_rotation_aggressive_feature_snapshot_latest.csv.manifest.json
NOTIFY_LANG=zh
```

## Rehearsal Sequence

1. Publish a fresh `russell_top50_leader_rotation_aggressive` snapshot/manifest/ranking/release summary to the GCS prefix above.
