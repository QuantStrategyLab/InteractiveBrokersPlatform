...
grep -Fq 'CLOUD_RUN_SERVICE: ${{ secrets.CLOUD_RUN_SERVICE }}' "$workflow_file"
grep -Fq 'CLOUD_RUN_SERVICES: ${{ secrets.CLOUD_RUN_SERVICES }}' "$workflow_file"
...
grep -Fq "steps.config.outputs.traffic_shift_enabled == 'true'" "$workflow_file"
grep -Fq "steps.config.outputs.scheduler_sync_enabled == 'true'" "$workflow_file"
...
grep -Fq 'managed_job_state_after=' "$workflow_file"
grep -Fq 'Scheduler state readback failed' "$workflow_file"
